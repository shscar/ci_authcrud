...
<?= $this->section('content') ?> 
    ...
    <div class="container mt-5">
        ...
        <form action="<?= route_to('update-siswa', $siswa['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="input-group mb-3">
                ...
                <!-- <div class="col-12">
                    <?php if ($siswa['image']): ?>
                    <img src="<?= base_url('assets/images/' . $siswa['image']) ?>" class="img-thumbnail mb-2" width="150">
                    <?php endif; ?>
                </div> -->
                <input type="file" class="form-control-file" id="image" name="image" value="<?= $siswa['image'] ?>" accept="image/*">
